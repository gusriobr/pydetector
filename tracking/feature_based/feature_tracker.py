...
class FeatureStats():
    ...
    def __str__(self):
        return "Train/qry kpts: %s/%s, matches/good %s/%s = %.2f%%" % (
            self.num_train_kpts, self.num_query_kpts, self.num_matches, self.num_good_matches, self.rate_matches)

    def update(self):
        self.rate_matches = 100*(self.num_good_matches / float(self.num_matches))
...
class FeatureDetector():
    ...
    def show_template_matches_knn(self, t_image):
        ...
        # update stats
        self.stats.num_train_kpts = len(kp2)
        ...
        self.stats.num_matches = len(matches)
        ...
        self.stats.num_good_matches = len(good)
        self.stats.update()
